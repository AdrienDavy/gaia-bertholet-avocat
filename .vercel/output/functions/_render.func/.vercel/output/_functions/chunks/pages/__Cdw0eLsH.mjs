import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, u as unescapeHTML, i as renderHead, j as renderComponent, k as renderSlot } from '../astro_DG-dqEcf.mjs';
import 'kleur/colors';
import 'clsx';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faChevronDown } from '@fortawesome/free-solid-svg-icons';
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_Ct88KXWl.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_Ct88KXWl.mjs'
    ).then(n => n.g).catch((e) => {
...
const $$CommonHead = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<head><meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><meta name="description"${addAttribute(description, "content")}>${!!data.cssVariables && renderTemplate`<style>${unescapeHTML(`:root{${data.cssVariables}}`)}</style>`}${renderHead()}</head>`;
...
const $$Heading = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Heading;
  const { level, styles, classes, content } = Astro2.props;
  const Element = `h${level}`;
  return renderTemplate`${renderComponent($$result, "Element", Element, { "style": styles, "class": classes }, { "default": ($$result2) => renderTemplate`${unescapeHTML(content)}` })}`;
}, "D:/Adrien/Documents/Developpement Web/Site de Ga\xEFa/frontend_astro/gaia-bertholet-avocat-astro/src/components/Heading.astro", void 0);
...
const $$Cover = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(joinClasses(classes, "relative !min-h-0"), "class")}${addAttribute(styles, "style")}> ${!!url && renderTemplate`${renderComponent($$result, "Image", $$Image, { "class": "absolute w-full object-cover h-full !max-w-full", "height": height || 1e3, "width": width || 1e3, "src": url, "alt": "", "widths": [240, 540, 720, width || 1e3], "quality": "low", "loading": "eager" })}`} <div class="absolute bottom-8 z-10 text-blue-light text-center left-1/2 -translate-x-1/2 flex-col flex"> <button type="button" class=""> ENTRER </button> ${renderComponent($$result, "FontAwesomeIcon", FontAwesomeIcon, { "className": "text-xs pl-1", "icon": faChevronDown })} </div> <div class="absolute top-0 right-0 bottom-0 left-0 bg-black !max-w-full !mt-0"${addAttribute(`opacity:${dimRatio / 100}; ${overlayStyle}`, "style")}></div> <div${addAttribute(minHeightValue, "style")} class="z-10 relative !mt-0 min-h-[430px] flex flex-col justify-center gap-4"> ${renderSlot($$result, $$slots["default"])} </div> </div>`;
...
const $$ArticleSearch = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$c, $$props, $$slots);
  Astro2.self = $$ArticleSearch;
  return renderTemplate`${maybeRenderHead()}<form method="GET" class="w-full py-5 px-10 flex flex-col justify-center"> <div class="w-full py-5 flex flex-col justify-center"> <input type="text" class="w-full sm:w-8/12 text-blue-sky mx-auto inline-block uppercase font-bold tracking-[1.3px] border border-solid border-blue-light focus:border focus:border-solid focus:border-blue-800
      rounded-sm py-3 px-6" placeholder="Rechercher par mot-clé..."> </div> <button type="submit" class="text-white w-1/4 mx-auto inline-block uppercase font-bold tracking-[1.3px] bg-blue-sky rounded-full py-3 px-6">Rechercher</button> </form>`;
}, "D:/Adrien/Documents/Developpement Web/Site de Ga\xEFa/frontend_astro/gaia-bertholet-avocat-astro/src/components/ArticleSearch.astro", void 0);
...
const $$LatestPosts = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const articleUrl = (uri) => `${Astro2.url.origin}${uri}`;
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`${postLayout} sm:flex justify-${featuredImageAlign} text-${textColor} mx-auto sm:w-8/12 justify-between pb-40`, "class")}> ${posts.slice(0, postsToShow).map((post) => renderTemplate`<a${addAttribute(articleUrl(post.uri), "href")}> <article${addAttribute(imageSize(featuredImageSizeSlug || ""), "class")}> ${displayFeaturedImage && post.featuredImage && renderTemplate`<img${addAttribute(post.featuredImage.node.sourceUrl, "src")}${addAttribute(post.featuredImage.node.altText, "alt")} class="object-cover h-full w-full">`} <div class="text-center"> <h2>${post.title}</h2> ${displayPostDate && renderTemplate`<p>${formatDate(post.date)}</p>`} ${displayPostContent && renderTemplate`<div>${unescapeHTML(truncateText(post.excerpt, excerptLength || 30))}</div>`} </div> </article> </a>`)} </div>`;
}, "D:/Adrien/Documents/Developpement Web/Site de Ga\xEFa/frontend_astro/gaia-bertholet-avocat-astro/src/components/LatestPosts.astro", void 0);

const $$Astro$a = createAstro();
const $$BlockRenderer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$a, $$props, $$slots);
  Astro2.self = $$BlockRenderer;
  const { blocks, posts, renderLatestPosts } = Astro2.props;
  return renderTemplate`${blocks.map((block) => {
    ...
    if (block.name === "core/latest-posts" && renderLatestPosts) {
      return renderTemplate`${maybeRenderHead()}<div${addAttribute(styles, "style")}${addAttribute(classes, "class")}>${renderComponent($$result, "LatestPosts", $$LatestPosts, { "posts": posts || [], "postsToShow": block.attributes?.postsToShow || 2, "displayPostContent": block.attributes?.displayPostContent || true, "excerptLength": block.attributes?.excerptLength || 30, "displayPostDate": block.attributes?.displayPostDate || true, "postLayout": block.attributes?.postLayout || "", "displayFeaturedImage": block.attributes?.displayFeaturedImage || "", "featuredImageAlign": block.attributes?.featuredImageAlign || "", "featuredImageSizeSlug": block.attributes?.featuredImageSizeSlug || "", "textColor": block.attributes?.textColor || "" })}</div>`;
    }
    switch (block.name) {
      case "astro/article-search":
        return renderTemplate`${renderComponent($$result, "ArticleSearch", $$ArticleSearch, {})}`;
      case "core/gallery":
        return renderTemplate`<div${addAttribute(styles, "style")}${addAttribute(classes, "class")}>${(block.innerBlocks || []).map((innerBlock) => renderTemplate`<div>${renderComponent($$result, "BlockRendererInner", $$BlockRenderer, { "blocks": [innerBlock], "renderLatestPosts": renderLatestPosts, "posts": posts || [] })}</div>`)}</div>`;
      case "core/image":
        return renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": block.attributes?.url, "height": block.attributes?.height, "width": block.attributes?.width, "class": classes, "style": styles, "alt": block.attributes?.alt || "" })}`;
      case "core/button":
        return renderTemplate`${renderComponent($$result, "Button", $$Button, { "classes": classes, "styles": styles, "url": block.attributes?.url, "content": block.attributes?.content || "" })}`;
      case "core/post-title":
      case "core/heading":
        return renderTemplate`${renderComponent($$result, "Heading", $$Heading, { "level": block.attributes?.level || 2, "classes": classes, "styles": styles, "content": block.attributes?.content || "" })}`;
      case "core/cover":
        return renderTemplate`${renderComponent($$result, "Cover", $$Cover, { "classes": classes, "styles": styles, "url": block.attributes?.url, "height": block.attributes?.height, "width": block.attributes?.width, "dimRatio": block.attributes?.dimRatio, "overlayColor": block.attributes?.overlayColor, "customOverlayColor": block.attributes?.customOverlayColor, "minHeight": block.attributes?.minHeight, "minHeightUnit": block.attributes?.minHeightUnit }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "BlockRendererInner", $$BlockRenderer, { "blocks": block.innerBlocks || [], "renderLatestPosts": renderLatestPosts, "posts": posts || [] })}` })}`;
      case "core/paragraph":
        return renderTemplate`${renderComponent($$result, "Paragraph", $$Paragraph, { "classes": classes, "styles": styles, "content": block.attributes?.content })}`;
      case "core/columns":
      case "core/column":
      case "core/post-content":
      case "core/group":
      case "core/buttons":
        return renderTemplate`<div${addAttribute(styles, "style")}${addAttribute(classes, "class")}>${renderComponent($$result, "BlockRendererInner", $$BlockRenderer, { "blocks": block.innerBlocks || [], "renderLatestPosts": renderLatestPosts, "posts": posts || [] })}</div>`;
      case "core/list":
        return renderTemplate`<ul${addAttribute(styles, "style")}${addAttribute(classes, "class")}>${renderComponent($$result, "BlockRendererInner", $$BlockRenderer, { "blocks": block.innerBlocks || [], "renderLatestPosts": renderLatestPosts, "posts": posts || [] })}</ul>`;
      case "core/list-item":
        return renderTemplate`${renderComponent($$result, "ListItem", $$ListItem, { "classes": classes, "styles": styles, "content": block.attributes?.content })}`;
      default:
        return null;
    }
  })}`;
  ...
  return renderTemplate`${blocks.map((block) => {
    ...
    switch (block.name) {
      case "core/image":
        return renderTemplate`${renderComponent($$result, "Image", $$Image, { "src": block.attributes?.url, "height": block.attributes?.height, "width": block.attributes?.width, "class": classes, "style": styles, "alt": block.attributes?.alt || "" })}`;
      case "core/button":
        return renderTemplate`${renderComponent($$result, "ButtonFooter", $$ButtonFooter, { "classes": classes, "styles": styles, "url": block.attributes?.url, "content": block.attributes?.content || "" })}`;
      case "core/post-title":
      case "core/heading":
        return renderTemplate`${renderComponent($$result, "Heading", $$Heading, { "level": block.attributes?.level || 2, "classes": classes, "styles": styles, "content": block.attributes?.content || "" })}`;
      case "core/paragraph":
      ...
      case "core/list":
        return renderTemplate`<ul${addAttribute(styles, "style")}${addAttribute(classes, "class")}>${renderComponent($$result, "FooterInner", $$Footer, { "blocks": block.innerBlocks || [] })}</ul>`;
      case "core/list-item":
        return renderTemplate`${renderComponent($$result, "ListItem", $$ListItem, { "classes": classes, "styles": styles, "content": block.attributes?.content })}`;
      case "core/social-links":
        return renderTemplate`<div${addAttribute(classes, "class")}${addAttribute(styles, "style")}>${renderComponent($$result, "FooterInner", $$Footer, { "blocks": block.innerBlocks || [] })}</div>`;
      case "core/social-link":
        return renderTemplate`${renderComponent($$result, "SocialLink", $$SocialLink, { "url": block.attributes?.url, "service": block.attributes?.service, "classes": classes, "styles": styles })}`;
      case "core/site-logo":
        return renderTemplate`<div${addAttribute(styles, "style")}${addAttribute(classes, "class")}><a${addAttribute(homeUrl, "href")} title="Vers l'accueil">${renderComponent($$result, "Image", $$Image, { "height": block.attributes?.height || 180, "width": block.attributes?.width || 180, "src": block.attributes?.url || "", "alt": "" })}</a></div>`;
...
const $$Navigation = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allClasses = joinClasses(classes, "w-full flex-between max-sm:flex-col");
  return renderTemplate`${maybeRenderHead()}<nav class="w-10/12"> <ul${addAttribute(allClasses, "class")}${addAttribute(styles, "style")}> ${renderSlot($$result, $$slots["default"])} </ul> </nav>`;
...
const $$NavigationLink = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const href = replaceUrls(url, Astro2.url.host);
  return renderTemplate`${maybeRenderHead()}<li${addAttribute(classes, "class")}${addAttribute(styles, "style")}> <a${addAttribute(href, "href")} class=""> ${label} </a> </li>`;
...
const $$NavigationSubmenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { styles, classes, label, url } = Astro2.props;
  const allClasses = joinClasses(classes, "group relative flex justify-center");
  const href = replaceUrls(url, Astro2.url.host);
  return renderTemplate`${maybeRenderHead()}<li${addAttribute(allClasses, "class")}${addAttribute(styles, "style")}> <a${addAttribute(href, "href")} class="block w-full py-3 sm:py-0 px-4"> ${label} ${renderComponent($$result, "FontAwesomeIcon", FontAwesomeIcon, { "className": "text-xs pl-1", "icon": faChevronDown })} </a> <ul class="z-20 sm:hidden sm:group-hover:block bg-starlight sm:absolute sm:top-full sm:text-center whitespace-nowrap py-2 shadow-lg rounded-bl-xl rounded-br-xl"> ${renderSlot($$result, $$slots["default"])} </ul> </li>`;
...
const $$NavigationSubLink = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allClasses = joinClasses(
    classes,
    "py-2 px-4 hover:bg-blue-sky hover:text-starlight"
  );
  ...
  return renderTemplate`${blocks.map((block) => {
    ...
    switch (block.name) {
      ...
      case "core/navigation-submenu":
        return renderTemplate`${renderComponent($$result, "NavigationSubmenu", $$NavigationSubmenu, { "classes": classes, "styles": styles, "label": block.attributes?.label || "", "url": block.attributes?.url || "" }, { "default": ($$result2) => renderTemplate`${block.innerBlocks?.map((link) => renderTemplate`${renderComponent($$result2, "NavigationSubLink", $$NavigationSubLink, { "classes": classes, "styles": styles, "label": link.attributes?.label || "", "url": link.attributes?.url || "" })}`)}` })}`;
      case "core/navigation-link":
        return renderTemplate`${renderComponent($$result, "NavigationLink", $$NavigationLink, { "classes": classes, "styles": styles, "label": block.attributes?.label || "", "url": block.attributes?.url || "" })}`;
      case "core/navigation":
        return renderTemplate`${renderComponent($$result, "Navigation", $$Navigation, { "classes": classes, "styles": styles }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "HeaderInner", $$Header, { "blocks": block.innerBlocks || [] })}` })}`;
      case "core/group":
      ...
      case "core/site-logo":
        return renderTemplate`${maybeRenderHead()}<div${addAttribute(styles, "style")}${addAttribute(classes, "class")}><a class="image-footer"${addAttribute(homeUrl, "href")} title="Vers l'accueil">${renderComponent($$result, "Image", $$Image, { "height": block.attributes?.height || 120, "width": block.attributes?.width || 120, "src": block.attributes?.url || "", "alt": "" })}</a></div>`;
      case "core/template-part":
